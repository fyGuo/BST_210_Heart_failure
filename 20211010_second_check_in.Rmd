---
title: "20111105_second_check_in"
author: "Fuyu Guo"
date: "11/5/2021"
output: pdf_document
---
...
#############################
# load data
dta <- read.csv("/Users/fuyuguo/BST_210_Heart_failure/heart_f.csv")
...
```
The residuals are not normally distributed. Also the residuals are clearly linear associated with the outcome. Thus, the linear model's assumption about nomarlity is violated.
